...
parser.add_argument('--lr_min', default=0.0002, type=float, help='SSM Learning rate')
parser.add_argument('--lr_dt', default=0.0, type=float, help='dt lr')
parser.add_argument('--min_dt', default=0.0001, type=float, help='min dt')
    ...
    if True:
        ...
        if acc > best_acc:
            ...
            if not os.path.isdir('checkpoint'):
                os.mkdir('checkpoint')
            torch.save(state, './checkpoint/' + args.path + 'resume.pth')
            best_acc = acc
